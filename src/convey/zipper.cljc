...
#?(:clj  (defmethod branch? clojure.lang.MapEntry [s] true))
...
#?(:cljs (defmethod branch? cljs.core/MapEntry [s] true))
...
#?(:clj  (defmethod seq-children clojure.lang.MapEntry [me] me))
...
#?(:cljs (defmethod seq-children cljs.core/MapEntry [me] me))
...
#?(:clj  (defmethod make-node clojure.lang.MapEntry [v children] (vec children)))
...
#?(:cljs (defmethod make-node cljs.core/MapEntry [v children] (vec children)))
